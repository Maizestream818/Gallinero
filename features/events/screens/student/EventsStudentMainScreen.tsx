...
// - Al tocar una card, abre el EventDetailModal con el detalle del evento.
...
export function EventsStudentMainScreen() {
  ...
  // Toda la lógica de clasificación y filtrado centralizada en el hook
    ...
    <SafeAreaView style={{ flex: 1 }} edges={['top', 'left', 'right']}>
      <View className="flex-1 bg-slate-50 dark:bg-slate-900">
        ...
        >
          ...
          {searchText.trim().length > 0 && totalFiltered === 0 ? (
          ...
          <View className="mt-10">
            ...
            {upcomingEvents.length === 0 ? (
              ...
              <View className="flex-col">{upcomingEvents.map(renderEventCard)}</View>
            )}
          </View>
        </ScrollView>
