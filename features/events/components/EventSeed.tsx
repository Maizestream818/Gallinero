...
export const EVENTS_SEED: EventStudentItem[] = [
  ...
  description: 'Vive la increíble experiencia de Shrek en pantalla grande',
  location: 'Infoteca',
  organizer: 'Equipo Gallinero',
  startsAtIso: new Date().toISOString(),
...
{
  id: 'evt-24',
  title: 'Ballet en la Universidad',
  description: 'Acompañanos a la gran experiencia de la danza folclorica',
  location: 'Jardin de las Generaciones',
  organizer: 'Equipo Gallinero',
  startsAtIso: new Date().toISOString(),
  tags: ['Ballet Folclorico Universidad'], 
  durationMinutes: 90,
},
{
  id: 'evt-25',
  title: 'Maraton de eventos',
  description: 'Acompañanos a un maraton de eventos para promover la cultura en la universidad',
  location: 'Jardin de las Generaciones',
  organizer: 'Equipo Gallinero',
  startsAtIso: new Date().toISOString(),
  tags: ['Ballet Folclorico Universidad', 'Cinema Universidad', 'Museo Nacional de la Muerte', 'Helikón'], 
  durationMinutes: 200,
},
];
